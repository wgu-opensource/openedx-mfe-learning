...
const MobileMenuTrigger = ({ tag, className, ...attributes }) => React.createElement(tag, {
...
const MobileMenuTriggerType = <MobileMenuTrigger />.type;

const MobileMenuContent = ({ tag, className, ...attributes }) => React.createElement(tag, {
...
class MobileMenu extends React.Component {
  ...
  render() {
    ...
    const wrappedChildren = React.Children.map(this.props.children, (child) => {
      if (child.type === MobileMenuTriggerType) {
        return this.renderTrigger(child);
      }
      return this.renderMobileMenuContent(child);
    });
...
MobileMenu.propTypes = menuPropTypes;
